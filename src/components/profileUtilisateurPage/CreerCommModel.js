...
import styles from "./creerCommModel.module.css";

function CreerCommModel() {
  ...
  return (
    <div className={`modal fade `} id="creerCommModel" tabIndex="-1" aria-labelledby="creerCommModelLabel" aria-hidden="true">
      <div className="modal-dialog">
        <div className="modal-content">
          <div className={`modal-header ${styles.container}`}>
            <h1 className="modal-title fs-5" id="creerCommModelLabel">
              Créer communauté
            </h1>
          </div>
